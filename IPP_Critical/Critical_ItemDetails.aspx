<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Critical_ItemDetails.aspx.cs" Inherits="Critical_ItemDetails" %>
...
<script language=javascript>
    ...
    function openCommand(url, name, partID, lotID, paramID, userID, e) 
    {
        ...
        var fertrue = "height=630,width=800,top=" + xPosition + ",left=" + yPosition + ",toolbar=no,menubar=no,scrollbars=yes,resizable=yes,location=no,status=no";
        ...
        html += "<input type='hidden' name='fType' value='Critical_Item'/>";
...
<!-- Ext.NET -->
<ext:Window ID="Window1" runat="server" Closable="false" Resizable="false" Height="150" Width="350" Icon="Lock" Title="Login For Command" Draggable="false" Modal="true" BodyPadding="5" Layout="FormLayout" X=600 Y=1600 >
<Items>
<ext:TextField 
ID="txtUsername" 
runat="server"                     
...
<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
       BackColor="White" BorderColor="Black" BorderStyle="None" BorderWidth="1px" 
        CellPadding="3" Width="1100px" onrowdatabound="GridView1_RowDataBound">
        ...
        <Columns>
            ...
            <asp:BoundField DataField="part" HeaderText="Part ID" />
            <asp:BoundField DataField="Lot" HeaderText="Lot ID" />
            <asp:BoundField DataField="Parametric_Measurement" HeaderText="Parametric" />
            <asp:BoundField DataField="MPID" HeaderText="Process Station"></asp:BoundField>
            <asp:BoundField DataField="EQPID" HeaderText="Process Machine" />
            <asp:BoundField DataField="Layer" HeaderText="Layer" />
            <asp:BoundField DataField="trtm" HeaderText="ProcessTime" />
            <asp:BoundField DataField="MeasureTime" HeaderText="MeasureTime"></asp:BoundField>
