<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FailDetail.aspx.cs" Inherits="FailDetail" %>
...
<ext:Tab Text="Fail Detail"  ActionItemID="elm2" />
...
<asp:GridView ID="gv_pie" runat="server" BackColor="White" BorderColor="Black" 
        BorderStyle="None" BorderWidth="1px" CellPadding="3" 
        onrowdatabound="gv_pie_RowDataBound1">
<AlternatingRowStyle BackColor="#DBEEFF" />
<EditRowStyle BackColor="#999999" />
<FooterStyle BackColor="#5D7B9D" Font-Bold="True" ForeColor="White" />
<HeaderStyle BackColor="#5D7B9D" Font-Bold="True" ForeColor="White" />
...
<asp:GridView ID="gr_lotview" runat="server" BackColor="White" BorderColor="Black" 
        BorderStyle="None" BorderWidth="1px" CellPadding="3" 
        onrowdatabound="gr_lotview_RowDataBound1">
<AlternatingRowStyle BackColor="#DBEEFF" />
<EditRowStyle BackColor="#999999" />
<FooterStyle BackColor="#5D7B9D" Font-Bold="True" ForeColor="White" />
<HeaderStyle BackColor="#5D7B9D" Font-Bold="True" ForeColor="White" />
